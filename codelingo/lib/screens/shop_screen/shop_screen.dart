  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        bigTitle('Outfits'),
        item('assets/images/oscar1.png', 'Formal Attire',
            'Learn in style. Oscar has always been a sharp guy, now he\'ll look sharp too.', 1000, null, null),
        item('assets/images/oscar2.png', 'Luxury Tracksuit',
            'Learn in luxury. Oscar will love the feel of 24 carat gold silk on his shoulders.', 2000, null, null),
        item('assets/images/oscar3.png', 'Super Oscar',
            'Transform Oscar from a humble Man into a fearless crimefighter.', 3000, null, null),
      ],
    );
  }
