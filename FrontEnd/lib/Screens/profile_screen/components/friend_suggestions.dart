      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              friendBox('assets/images/zeina.png', 'Zeina', 'Habiba'),
              friendBox('assets/images/ann.png', 'Ann', 'Raghda'),
              friendBox('assets/images/jana.png', 'Jana', 'Ahmed Saeed'),
              friendBox('assets/images/zahar.png', 'Mostafa', 'Nour'),
              friendBox('assets/images/youssef.png', 'Youssef', 'Shehab'),
            ],
          ),
        ),
      ],
